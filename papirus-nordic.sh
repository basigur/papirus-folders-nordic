...
local _res
  ...
  cp -r Papirus-nordic/16x16/places/*.svg "${_src}"/Papirus-nordic-folders/16x16/places/
  cp -r Papirus-nordic/16x16/places/*.svg "${_src}"/Papirus-Dark-nordic-folders/16x16/places/
  cp -r Papirus-nordic/16x16/places/*.svg "${_src}"/ePapirus-nordic-folders/16x16/places/
...
sed -i 's!Papirus-nordic,!Papirus,!' "${_src}"/Papirus-nordic-folders/index.theme
sed -i 's!Papirus-Light-nordic,!Papirus-Light,!' "${_src}"/Papirus-Light-nordic-folders/index.theme
sed -i 's!Papirus-Dark-nordic,!Papirus-Dark,!' "${_src}"/Papirus-Dark-nordic-folders/index.theme
sed -i 's!ePapirus-nordic,!ePapirus,!' "${_src}"/ePapirus-nordic-folders/index.theme
sed -i 's!Papirus-nordic,!Papirus-nordic-folders,!' "${_src}"/Papirus-nordic-blue-folders/index.theme
sed -i 's!Papirus-Light-nordic,!Papirus-Light-nordic-folders,!' "${_src}"/Papirus-Light-nordic-blue-folders/index.theme
sed -i 's!Papirus-Dark-nordic,!Papirus-Dark-nordic-folders,!' "${_src}"/Papirus-Dark-nordic-blue-folders/index.theme
sed -i 's!ePapirus-nordic,!ePapirus-nordic-folders,!' "${_src}"/ePapirus-nordic-blue-folders/index.theme
sed -i 's!Papirus-nordic,!Papirus-nordic-folders,!' "${_src}"/Papirus-nordic-green-folders/index.theme
sed -i 's!Papirus-Light-nordic,!Papirus-Light-nordic-folders,!' "${_src}"/Papirus-Light-nordic-green-folders/index.theme
sed -i 's!Papirus-Dark-nordic,!Papirus-Dark-nordic-folders,!' "${_src}"/Papirus-Dark-nordic-green-folders/index.theme
sed -i 's!ePapirus-nordic,!ePapirus-nordic-folders,!' "${_src}"/ePapirus-nordic-green-folders/index.theme
