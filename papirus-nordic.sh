...
pf_nordic(){
  ...
  local _res
     ...
     do
       ...
       ln -s folder-nordic-android.svg "${_src}"/Papirus-nordic/"${_res}x${_res}"/places/folder-android.svg
       ln -s folder-nordic-apple.svg "${_src}"/Papirus-nordic/"${_res}x${_res}"/places/folder-apple.svg
       ln -s folder-nordic-arduino.svg "${_src}"/Papirus-nordic/"${_res}x${_res}"/places/folder-arduino.svg
       ln -s folder-nordic-backup.svg "${_src}"/Papirus-nordic/"${_res}x${_res}"/places/folder-backup.svg
       ...
       ln -s folder-nordic-books.svg "${_src}"/Papirus-nordic/"${_res}x${_res}"/places/folder-books.svg
       ...
       ln -s folder-nordic-kde.svg "${_src}"/Papirus-nordic/"${_res}x${_res}"/places/folder-kde.svg
       ...
       ln -s folder-nordic-nextcloud.svg "${_src}"/Papirus-nordic/"${_res}x${_res}"/places/folder-nextcloud.svg
       ...
       ln -s folder-nordic-projects.svg "${_src}"/Papirus-nordic/"${_res}x${_res}"/places/folder-projects.svg
